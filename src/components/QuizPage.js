...
const QuizPage = () => {
  ...
  const quizzes = {
    1: [
      ...
      { question: "Sobre a 'Guerra dos Cabanos', informe se é verdadeiro (V) ou falso (F) o que se afirma a seguir e assinale a alternativa com a sequência correta: ( ) Ocorreu entre 1832 e 1835 e teve como um dos propósitos dos revoltosos a volta de Pedro I ao trono do Império. O conflito esteve inserido no contexto do período regencial.     ( ) Manoel de carvalho Paes de Andrade, que participou de revoltas como a Revolução Perrnambucana e a Confederação do Equador, foi um dos líderes no combate aos revoltosos na Guerra dos cabanos.    ( ) O conflito ocorreu em grande parte no interior de Pernambuco e teve participação plural de grupos sociais, como indígenas, escravizados, pequenos proprietários de terra, entre outros.    ( ) Teve como um dos aspectos o caráter messiânico em que o líder da revolta, Antônio Conselheiro, era considerado uma espécie de personagem divino.", options: ["V - F - V - F.", "F - F - V - V.", "V - V - V - F.", "V - V - F - F.", "F - F - F - V."], answer: "C"},
      { question: "Qual personagem histórico participou de forma incisiva de duas importantes revoltas na História de Pernambuco, sendo elas a Revoloção Pernambucana e a Confederação do Equador?", options: ["Vigário Tenório.", "José Luís de Mendonça.", "Padre João Ribeiro.", "Domingos José Martins.", "Frei Caneca."], answer: "E"},
      { question: "A formação de Olinda está relacionada a um fidalgo português que chegou à região em 1534. Esse personagem histórico é:", options: ["Tristão de Mendonça.", "Matias de alburquerque.", "Tomé de Souza.", "Maurício de Nassau.", "Duarte Coelho."], answer: "E"},
    ],
  };
